...
func TestRoutesPersistence(t *testing.T) {
	tmpdir1, _ := os.MkdirTemp("", "cassetteos-gateway-route-test")
	tmpdir2, _ := os.MkdirTemp("", "cassstteos-gateway-route-test")
...
func TestPathSorting(t *testing.T) {
	tmpdir, _ := os.MkdirTemp("", "cassetteos-gateway-route-test")
